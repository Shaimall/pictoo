...
function Mobilenav() {
  return (
    <div className="block md:hidden">
      ...
      <div className="p-6 w-1/2 h-screen bg-gradient-to-tr from-pink-300 to-purple-200 z-20 fixed top-0 -right-96  peer-focus:right-0 peer:transition ease-out delay-150 duration-200">
        <div className="flex flex-col justify-start item-center">
          ...
          <div className=" my-4 border-b border-gray-100 pb-4">
            ...
            <div className="flex  mb-2 justify-start items-center gap-4 pl-5 hover:bg-gradient-to-tr from-orange-400 to-red-500 rounded-xl   p-2  ">
              <button className="text-base text-white bg-[#A53DFF] px-4 py-2 rounded-lg group-hover:text-white font-semibold ">
                Contact
              </button>
            </div>
          </div>
